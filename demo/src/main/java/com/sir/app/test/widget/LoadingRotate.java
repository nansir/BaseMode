package com.sir.app.test.widget;
...
/**
 * Loading
 * Created by zhuyinan on 2017/7/20.
...
public class LoadingRotate extends View {
    ...
    public LoadingRotate(Context context) {
        super(context);
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        if (null != attrs) {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.LoadingRotate);
            color = typedArray.getColor(R.styleable.LoadingRotate_loading_color, Color.WHITE);
            width = typedArray.getDimensionPixelSize(R.styleable.LoadingRotate_loading_width, dpToPx(context, DEFAULT_WIDTH));
            shadowPosition = typedArray.getInt(R.styleable.LoadingRotate_shadow_position, DEFAULT_SHADOW_POSITION);
            speedOfDegree = typedArray.getInt(R.styleable.LoadingRotate_loading_speed, DEFAULT_SPEED_OF_DEGREE);
            loadingState = typedArray.getBoolean(R.styleable.LoadingRotate_loading_state, false);
            typedArray.recycle();
        }
    ...
    public LoadingRotate(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public LoadingRotate(Context context, AttributeSet attrs, int defStyleAttr) {
